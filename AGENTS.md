...
config/wedge-alarm  optional away-mode wedge-alarm active-alert directives; LOCAL, gitignored; absent means auto (this platform's own reachable channels), and a first away-mode entry refuses when none can reach the captain while a re-entry reports and still re-arms; see docs/wedge-alarm.md
