...
config/wedge-alarm  optional away-mode wedge-alarm active-alert directives; LOCAL, gitignored; absent means auto (this platform's own reachable channels), and away-mode entry refuses when none can reach the captain; see docs/wedge-alarm.md
